...
public class LoginTest extends iTrustSeleniumTest {
	...
	public void testResetPassword() throws Exception {
		...
		// Select Patient and input mid
		Select dropdown = new Select(wd.findElement(By.tagName("select")));
		dropdown.selectByVisibleText("Patient");
		wd.findElement(By.name("mid")).sendKeys("1");
		wd.findElement(By.name("mid")).submit();
		...
		wd.findElement(By.name("confirmPassword")).submit();
