...
public class GetLabProceduresTest extends TestCase {
    ...
    public void testFailGetLabProceduresMidNull() throws Exception {
        try {
            lpDAO.getLabProcedures(0L, 905L);
            fail();
        } catch (DBException e) {
    ...
    public void testFailGetLabProceduresPidNull() throws Exception {
        try {
            lpDAO.getLabProcedures(905L, 0L);
            fail();
        } catch (DBException e) {
            assertEquals("HCP id cannot be null", e.getExtendedMessage());
        }
